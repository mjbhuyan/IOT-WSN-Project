...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b99458, const void *arg_0xb7b995f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b4a8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79f4840), 
int (*key_eq_fn)(void *arg_0xb79f4c88, void *arg_0xb79f4e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78c39b8, int arg_0xb78c3b10);
static double RandomUniform(void );
...
typedef nx_struct my_msg_connect {
  nx_uint8_t type;
} __attribute__((packed)) my_msg_connect_t;
...
typedef nx_struct my_msg_subscribe {
  ...
  nx_uint8_t topic[3];
  nx_int8_t qos[3];
} __attribute__((packed)) my_msg_subscribe_t;
...
typedef nx_struct my_msg_publish {
  ...
  nx_uint8_t topic;
  nx_uint8_t qos;
} __attribute__((packed)) my_msg_publish_t;
...
typedef nx_struct my_msg_forward {
  ...
  nx_uint8_t source;
  nx_uint8_t qos;
} __attribute__((packed)) my_msg_forward_t;




uint8_t connectedNodes[6];


int8_t subscriptions[6][2];



int8_t publishedMsgID[6];




int8_t nodesToForward[6];
...
typedef TMilli mqttC$Timer0$precision_tag;
typedef TMilli mqttC$Timer3$precision_tag;
typedef uint16_t mqttC$Read$val_t;
typedef TMilli mqttC$Timer1$precision_tag;
typedef TMilli mqttC$Timer4$precision_tag;
typedef TMilli mqttC$Timer2$precision_tag;
...
typedef TMilli /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$precision_tag;
typedef uint16_t /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t;
...
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
...
static void mqttC$SplitControl$startDone(error_t error);
#line 138
static void mqttC$SplitControl$stopDone(error_t error);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void mqttC$Timer0$fired(void );
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void mqttC$Boot$booted(void );
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void mqttC$Timer3$fired(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void mqttC$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void mqttC$sendForward$runTask(void );
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static void mqttC$Read$readDone(error_t result, mqttC$Read$val_t val);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void mqttC$sendConnect$runTask(void );
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void mqttC$Timer1$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void mqttC$Timer4$fired(void );
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void mqttC$initialize$runTask(void );
#line 75
static void mqttC$sendSubscribe$runTask(void );
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void mqttC$Timer2$fired(void );
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void mqttC$sendPublish$runTask(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );
# 62 "/opt/tinyos-main-2.1.2/tos/interfaces/Init.nc"
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t mqttC$SplitControl$start(void );
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void mqttC$Timer0$startOneShot(uint32_t dt);
#line 73
static void mqttC$Timer3$startOneShot(uint32_t dt);
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
static uint8_t mqttC$Packet$payloadLength(
#line 74
message_t * msg);
#line 126
static 
...
uint8_t len);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t mqttC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t mqttC$sendForward$postTask(void );
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t mqttC$Read$read(void );
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t mqttC$sendConnect$postTask(void );
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void mqttC$Timer1$startOneShot(uint32_t dt);
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t mqttC$initialize$postTask(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t mqttC$PacketAcknowledgements$requestAck(
#line 53
message_t * msg);
#line 71
static error_t mqttC$PacketAcknowledgements$noAck(
#line 65
message_t * msg);
#line 85
static bool mqttC$PacketAcknowledgements$wasAcked(
#line 80
message_t * msg);
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t mqttC$sendSubscribe$postTask(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void mqttC$Timer2$startPeriodic(uint32_t dt);
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
static am_addr_t mqttC$AMPacket$source(
#line 84
message_t * amsg);
#line 78
static am_addr_t mqttC$AMPacket$destination(
#line 74
message_t * amsg);
#line 147
static am_id_t mqttC$AMPacket$type(
#line 143
message_t * amsg);
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t mqttC$sendPublish$postTask(void );
# 46 "mqttC.nc"
enum mqttC$__nesc_unnamed4333 {
#line 46
  mqttC$initialize = 3U
};
#line 46
typedef int mqttC$__nesc_sillytask_initialize[mqttC$initialize];
enum mqttC$__nesc_unnamed4334 {
#line 47
  mqttC$sendConnect = 4U
};
#line 47
typedef int mqttC$__nesc_sillytask_sendConnect[mqttC$sendConnect];
enum mqttC$__nesc_unnamed4335 {
#line 48
  mqttC$sendSubscribe = 5U
};
#line 48
typedef int mqttC$__nesc_sillytask_sendSubscribe[mqttC$sendSubscribe];
enum mqttC$__nesc_unnamed4336 {
#line 49
  mqttC$sendPublish = 6U
};
#line 49
typedef int mqttC$__nesc_sillytask_sendPublish[mqttC$sendPublish];
enum mqttC$__nesc_unnamed4337 {
#line 50
  mqttC$sendForward = 7U
};
#line 50
typedef int mqttC$__nesc_sillytask_sendForward[mqttC$sendForward];
#line 33
uint8_t mqttC$nbNodesConnected[1000];
uint8_t mqttC$messageID[1000];
uint8_t mqttC$retransmission[1000];
uint16_t mqttC$valueRetrans[1000];
uint16_t mqttC$valueToForward[1000];
uint8_t mqttC$topicToForward[1000];
uint8_t mqttC$sourceToForward[1000];
uint8_t mqttC$index[1000];
uint8_t mqttC$forwardRetrans[1000];
uint8_t mqttC$forwarding[1000];
message_t mqttC$packet[1000];
#line 55
static inline void mqttC$initialize$runTask(void );
#line 72
static inline void mqttC$sendConnect$runTask(void );
#line 90
static inline void mqttC$sendSubscribe$runTask(void );
#line 124
static inline void mqttC$sendPublish$runTask(void );
...
static inline void mqttC$sendForward$runTask(void );
#line 194
static inline void mqttC$Boot$booted(void );
...
static inline void mqttC$Timer0$fired(void );





static inline void mqttC$Timer1$fired(void );





static inline void mqttC$Timer2$fired(void );
...
static inline void mqttC$Timer3$fired(void );





static inline void mqttC$Timer4$fired(void );





static inline void mqttC$SplitControl$startDone(error_t err);
#line 253
static inline void mqttC$SplitControl$stopDone(error_t err);




static void mqttC$AMSend$sendDone(message_t *buf, error_t err);
#line 328
static inline message_t *mqttC$Receive$receive(message_t *buf, void *payload, uint8_t len);
#line 415
static inline void mqttC$Read$readDone(error_t result, uint16_t data);
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt);
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static void /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void );
# 18 "FakeSensorP.nc"
static inline error_t /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );





static inline void /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
...
inline static am_id_t mqttC$AMPacket$type(message_t * amsg){
#line 147
...
#line 147
#line 78
inline static am_addr_t mqttC$AMPacket$destination(message_t * amsg){
#line 78
  unsigned short __nesc_result;
#line 78
...
#line 78
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t mqttC$sendForward$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(mqttC$sendForward);
#line 67
...
#line 67
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static am_addr_t mqttC$AMPacket$source(message_t * amsg){
#line 88
  unsigned short __nesc_result;
#line 88
...
#line 328
{
  int IDsource = mqttC$AMPacket$source(buf);
...
#line 332
      if (__nesc_ntoh_uint8(mess->type.nxdata) == 1) {
          sim_log_debug(208U, "radio_rec", "Message received at time %s \n", sim_time_string());
          sim_log_debug(209U, "radio_pack", ">>>Pack \n \t Payload length %hhu \n", mqttC$Packet$payloadLength(buf));
          sim_log_debug_clear(210U, "radio_pack", "\t Source: %hhu \n", IDsource);
          sim_log_debug_clear(211U, "radio_pack", "\t Destination: %hhu \n", mqttC$AMPacket$destination(buf));
          sim_log_debug_clear(212U, "radio_pack", "\t AM Type: %hhu \n", mqttC$AMPacket$type(buf));
          sim_log_debug_clear(213U, "radio_pack", "\t\t Message type: %hhu \n", __nesc_ntoh_uint8(mess->type.nxdata));
          if (connectedNodes[IDsource - 2] == 1) {
              sim_log_debug_clear(214U, "radio_ack", "WARNING: the CONNACK has not been received the previous attempt by the node %hhu \n", IDsource);
            }
          else 
#line 341
            {
              mqttC$nbNodesConnected[sim_node()]++;
            }
          connectedNodes[mqttC$AMPacket$source(buf) - 2] = 1;
          sim_log_debug_clear(215U, "radio_ack", "Here are the connected nodes (seen from the MQTT broker)  : [%hhu, %hhu, %hhu, %hhu, %hhu, %hhu, %hhu, %hhu] \n", connectedNodes[0], connectedNodes[1], connectedNodes[2], connectedNodes[3], connectedNodes[4], connectedNodes[5], connectedNodes[6], connectedNodes[7]);
          sim_log_debug_clear(216U, "radio_ack", "Number of connected nodes: %hhu \n", mqttC$nbNodesConnected[sim_node()]);
        }
      if (__nesc_ntoh_uint8(mess->type.nxdata) == 2 && connectedNodes[IDsource - 2] == 1) {
          my_msg_subscribe_t *mess_subscribe = (my_msg_subscribe_t *)payload;
          int i = 0;

#line 351
          sim_log_debug(217U, "radio_rec", "Message received at time %s \n", sim_time_string());
          sim_log_debug(218U, "radio_pack", ">>>Pack \n \t Payload length %hhu \n", mqttC$Packet$payloadLength(buf));
          sim_log_debug_clear(219U, "radio_pack", "\t Source: %hhu \n", IDsource);
          sim_log_debug_clear(220U, "radio_pack", "\t Destination: %hhu \n", mqttC$AMPacket$destination(buf));
          sim_log_debug_clear(221U, "radio_pack", "\t AM Type: %hhu \n", mqttC$AMPacket$type(buf));
          sim_log_debug_clear(222U, "radio_pack", "\t\t Message type: %hhu \n", __nesc_ntoh_uint8(mess_subscribe->type.nxdata));
          sim_log_debug_clear(223U, "radio_pack", "\t\t Topics: [%hhu %hhu %hhu]\n", __nesc_ntoh_uint8(mess_subscribe->topic[0].nxdata), __nesc_ntoh_uint8(mess_subscribe->topic[1].nxdata), __nesc_ntoh_uint8(mess_subscribe->topic[2].nxdata));
          sim_log_debug_clear(224U, "radio_pack", "\t\t QOS: [%d %d %d] \n", __nesc_ntoh_int8(mess_subscribe->qos[0].nxdata), __nesc_ntoh_int8(mess_subscribe->qos[1].nxdata), __nesc_ntoh_int8(mess_subscribe->qos[2].nxdata));
          for (i = 0; i < 3; i++) {
              if (__nesc_ntoh_uint8(mess_subscribe->topic[i].nxdata) == 1) {
                  subscriptions[IDsource - 2][i] = __nesc_ntoh_int8(mess_subscribe->qos[i].nxdata);
                }
            }
        }
      if (__nesc_ntoh_uint8(mess->type.nxdata) == 3) {
          if (mqttC$forwarding[sim_node()] == 1) {
              sim_log_debug(225U, "radio_rec", "The MQTT broker is busy, the publish request coming from the node %hhu is discarded\n", IDsource);
            }
          else 
#line 368
            {
...
#line 371
              mqttC$valueToForward[sim_node()] = __nesc_ntoh_uint16(mess_publish->value.nxdata);
              mqttC$topicToForward[sim_node()] = __nesc_ntoh_uint8(mess_publish->topic.nxdata);
              mqttC$sourceToForward[sim_node()] = IDsource;
              sim_log_debug(226U, "radio_rec", "Message received at time %s \n", sim_time_string());
              sim_log_debug(227U, "radio_pack", ">>>Pack \n \t Payload length %hhu \n", mqttC$Packet$payloadLength(buf));
              sim_log_debug_clear(228U, "radio_pack", "\t Source: %hhu \n", IDsource);
              sim_log_debug_clear(229U, "radio_pack", "\t Destination: %hhu \n", mqttC$AMPacket$destination(buf));
              sim_log_debug_clear(230U, "radio_pack", "\t AM Type: %hhu \n", mqttC$AMPacket$type(buf));
              sim_log_debug_clear(231U, "radio_pack", "\t\t Message type: %hhu \n", __nesc_ntoh_uint8(mess_publish->type.nxdata));
              sim_log_debug_clear(232U, "radio_pack", "\t\t Topic: %hhu \n", __nesc_ntoh_uint8(mess_publish->topic.nxdata));
              sim_log_debug_clear(233U, "radio_pack", "\t\t QOS: %hhu \n", __nesc_ntoh_uint8(mess_publish->qos.nxdata));
              sim_log_debug_clear(234U, "radio_pack", "\t\t Value: %hhu \n", __nesc_ntoh_uint16(mess_publish->value.nxdata));
              sim_log_debug_clear(235U, "radio_pack", "\t\t Message ID: %hhu \n", __nesc_ntoh_uint8(mess_publish->msgId.nxdata));
              if (__nesc_ntoh_uint8(mess_publish->msgId.nxdata) != publishedMsgID[IDsource - 2]) {
                  for (p = 0; p < 6; p++) {
                      nodesToForward[p] = subscriptions[p][mqttC$topicToForward[sim_node()] - 1];
                    }
                  publishedMsgID[IDsource - 2] = __nesc_ntoh_uint8(mess_publish->msgId.nxdata);
                  mqttC$index[sim_node()] = 0;
                  mqttC$forwarding[sim_node()] = 1;
                  mqttC$sendForward$postTask();
                }
              else 
#line 392
                {
                  sim_log_debug(236U, "radio_pack", "This publish message has already been received but the PUBACK hasn't been received by the node\n");
                }
            }
        }
    }
...
#line 399
      sim_log_debug(237U, "radio_rec", "Message received at time %s \n", sim_time_string());
      sim_log_debug(238U, "radio_pack", ">>>Pack \n \t Payload length %hhu \n", mqttC$Packet$payloadLength(buf));
      sim_log_debug_clear(239U, "radio_pack", "\t Source: %hhu \n", IDsource);
      sim_log_debug_clear(240U, "radio_pack", "\t Destination: %hhu \n", mqttC$AMPacket$destination(buf));
      sim_log_debug_clear(241U, "radio_pack", "\t AM Type: %hhu \n", mqttC$AMPacket$type(buf));
      sim_log_debug_clear(242U, "radio_pack", "\t\t Message type: %hhu \n", __nesc_ntoh_uint8(mess_forward->type.nxdata));
      sim_log_debug_clear(243U, "radio_pack", "\t\t Topic: %hhu \n", __nesc_ntoh_uint8(mess_forward->topic.nxdata));
      sim_log_debug_clear(244U, "radio_pack", "\t\t QOS: %hhu \n", __nesc_ntoh_uint8(mess_forward->qos.nxdata));
      sim_log_debug_clear(245U, "radio_pack", "\t\t Value: %hhu \n", __nesc_ntoh_uint16(mess_forward->value.nxdata));
      sim_log_debug_clear(246U, "radio_pack", "\t\t Initial source: %hhu \n", __nesc_ntoh_uint8(mess_forward->source.nxdata));
    }
  return buf;
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7663ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7663ac8) {
#line 78
    case 6:
#line 78
      __nesc_result = mqttC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7663ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7660178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7660178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t mqttC$SplitControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t mqttC$initialize$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(mqttC$initialize);
#line 67
...
{
  if (err == SUCCESS) {
      sim_log_debug(186U, "radio", "Radio on!\n");
      if (TOS_NODE_ID == 1) {
          sim_log_debug(187U, "role", "I'm node 1: I'm the MQTT Broker\n");
          mqttC$initialize$postTask();
        }
      if (TOS_NODE_ID > 1) {
          sim_log_debug(188U, "role", "I'm node %hhu: I'm a MQTT client node\n", TOS_NODE_ID);
        }
    }
  else {
      mqttC$SplitControl$start();
    }
}
...
#line 113
  mqttC$SplitControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  mqttC$SplitControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7663108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb7663108, msg, error);
#line 110
}
#line 110
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t mqttC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t mqttC$PacketAcknowledgements$requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
inline static void * mqttC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 72
{
  my_msg_connect_t *mess = (my_msg_connect_t *)mqttC$Packet$getPayload(&mqttC$packet[sim_node()], sizeof(my_msg_connect_t ));

#line 74
  __nesc_hton_uint8(mess->type.nxdata, 1);
  sim_log_debug(148U, "radio_send", "Try to send a connect request to node 1 (MQTT Broker) at time %s \n", sim_time_string());
  mqttC$PacketAcknowledgements$requestAck(&mqttC$packet[sim_node()]);
  if (mqttC$AMSend$send(1, &mqttC$packet[sim_node()], sizeof(my_msg_connect_t )) == SUCCESS) {
      sim_log_debug(149U, "radio_send", "Packet passed to lower layer successfully!\n");
      sim_log_debug(150U, "radio_pack", ">>>Pack\n \t Payload length %hhu \n", mqttC$Packet$payloadLength(&mqttC$packet[sim_node()]));
      sim_log_debug_clear(151U, "radio_pack", "\t Source: %hhu \n ", mqttC$AMPacket$source(&mqttC$packet[sim_node()]));
      sim_log_debug_clear(152U, "radio_pack", "\t Destination: %hhu \n ", mqttC$AMPacket$destination(&mqttC$packet[sim_node()]));
      sim_log_debug_clear(153U, "radio_pack", "\t AM Type: %hhu \n ", mqttC$AMPacket$type(&mqttC$packet[sim_node()]));
      sim_log_debug_clear(154U, "radio_pack", "\t\t Message type: %hhu \n", __nesc_ntoh_uint8(mess->type.nxdata));
    }
}
...
#line 90
{
  my_msg_subscribe_t *mess = (my_msg_subscribe_t *)mqttC$Packet$getPayload(&mqttC$packet[sim_node()], sizeof(my_msg_subscribe_t ));

#line 92
  __nesc_hton_uint8(mess->type.nxdata, 2);
  if (TOS_NODE_ID < 4) {
      __nesc_hton_int8(mess->qos[1 - 1].nxdata, 1);
      __nesc_hton_int8(mess->qos[2 - 1].nxdata, 1);
    }
  else 
#line 96
    {
      __nesc_hton_int8(mess->qos[1 - 1].nxdata, 0);
      __nesc_hton_int8(mess->qos[2 - 1].nxdata, 0);
    }
  if (TOS_NODE_ID % 2 == 0) {
      __nesc_hton_uint8(mess->topic[1 - 1].nxdata, 1);
      __nesc_hton_uint8(mess->topic[2 - 1].nxdata, 1);
    }
  else 
#line 103
    {
  ...
  sim_log_debug(155U, "radio_send", "Try to send a subscribe request to node 1 (MQTT Broker) at time %s \n", sim_time_string());
  mqttC$PacketAcknowledgements$requestAck(&mqttC$packet[sim_node()]);
  if (mqttC$AMSend$send(1, &mqttC$packet[sim_node()], sizeof(my_msg_subscribe_t )) == SUCCESS) {
      sim_log_debug(156U, "radio_send", "Packet passed to lower layer successfully!\n");
      sim_log_debug(157U, "radio_pack", ">>>Pack\n \t Payload length %hhu \n", mqttC$Packet$payloadLength(&mqttC$packet[sim_node()]));
      sim_log_debug_clear(158U, "radio_pack", "\t Source: %hhu \n ", mqttC$AMPacket$source(&mqttC$packet[sim_node()]));
      sim_log_debug_clear(159U, "radio_pack", "\t Destination: %hhu \n ", mqttC$AMPacket$destination(&mqttC$packet[sim_node()]));
      sim_log_debug_clear(160U, "radio_pack", "\t AM Type: %hhu \n ", mqttC$AMPacket$type(&mqttC$packet[sim_node()]));
      sim_log_debug_clear(161U, "radio_pack", "\t\t Message type: %hhu \n", __nesc_ntoh_uint8(mess->type.nxdata));
      sim_log_debug_clear(162U, "radio_pack", "\t\t Topic: [%hhu %hhu %hhu] \n", __nesc_ntoh_uint8(mess->topic[0].nxdata), __nesc_ntoh_uint8(mess->topic[1].nxdata), __nesc_ntoh_uint8(mess->topic[2].nxdata));
      sim_log_debug_clear(163U, "radio_pack", "\t\t QOS: [%d %d %d] \n", __nesc_ntoh_int8(mess->qos[0].nxdata), __nesc_ntoh_int8(mess->qos[1].nxdata), __nesc_ntoh_int8(mess->qos[2].nxdata));
    }
}

# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt){
#line 73
...
#line 18
{
  /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(10);
  return SUCCESS;
}

# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static error_t mqttC$Read$read(void ){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read();
#line 55
...
# 71 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t mqttC$PacketAcknowledgements$noAck(message_t * msg){
#line 71
  unsigned char __nesc_result;
#line 71
...
#line 133
  int found = 0;
  my_msg_forward_t *mess = (my_msg_forward_t *)mqttC$Packet$getPayload(&mqttC$packet[sim_node()], sizeof(my_msg_forward_t ));

#line 135
  __nesc_hton_uint8(mess->type.nxdata, 4);
  __nesc_hton_uint16(mess->value.nxdata, mqttC$valueToForward[sim_node()]);
  __nesc_hton_uint8(mess->source.nxdata, mqttC$sourceToForward[sim_node()]);
  __nesc_hton_uint8(mess->topic.nxdata, mqttC$topicToForward[sim_node()]);
  for (l = mqttC$index[sim_node()]; l < 6 && found == 0; l++) {
      if (mqttC$sourceToForward[sim_node()] != l + 2) {
          if (nodesToForward[l] == 1) {
              __nesc_hton_uint8(mess->qos.nxdata, subscriptions[l][mqttC$topicToForward[sim_node()] - 1]);
              found = 1;
              mqttC$index[sim_node()] = l;
              mqttC$PacketAcknowledgements$requestAck(&mqttC$packet[sim_node()]);
              if (mqttC$AMSend$send(l + 2, &mqttC$packet[sim_node()], sizeof(my_msg_forward_t )) == SUCCESS) {
                  sim_log_debug(164U, "radio_send", "The MQTT broker tries to forward the publish request to node %hhu at time %s \n", l + 2, sim_time_string());
                  sim_log_debug(165U, "radio_pack", ">>>Pack \n \t Payload length %hhu \n", mqttC$Packet$payloadLength(&mqttC$packet[sim_node()]));
                  sim_log_debug_clear(166U, "radio_pack", "\t Source: %hhu \n", mqttC$AMPacket$source(&mqttC$packet[sim_node()]));
                  sim_log_debug_clear(167U, "radio_pack", "\t Destination: %hhu \n", mqttC$AMPacket$destination(&mqttC$packet[sim_node()]));
                  sim_log_debug_clear(168U, "radio_pack", "\t AM Type: %hhu \n", mqttC$AMPacket$type(&mqttC$packet[sim_node()]));
                  sim_log_debug_clear(169U, "radio_pack", "\t\t Message type: %hhu \n", __nesc_ntoh_uint8(mess->type.nxdata));
                  sim_log_debug_clear(170U, "radio_pack", "\t\t Topic: %hhu \n", __nesc_ntoh_uint8(mess->topic.nxdata));
                  sim_log_debug_clear(171U, "radio_pack", "\t\t QOS: %d \n", __nesc_ntoh_uint8(mess->qos.nxdata));
                  sim_log_debug_clear(172U, "radio_pack", "\t\t Value: %hhu \n", __nesc_ntoh_uint16(mess->value.nxdata));
                  sim_log_debug_clear(173U, "radio_pack", "\t\t Initial source: %hhu \n", __nesc_ntoh_uint8(mess->source.nxdata));
                }
            }
          else {
#line 158
            if (nodesToForward[l] == 0) {
                __nesc_hton_uint8(mess->qos.nxdata, subscriptions[l][mqttC$topicToForward[sim_node()] - 1]);
                mqttC$PacketAcknowledgements$noAck(&mqttC$packet[sim_node()]);
                found = 1;
                mqttC$index[sim_node()] = l;
                if (mqttC$AMSend$send(l + 2, &mqttC$packet[sim_node()], sizeof(my_msg_forward_t )) == SUCCESS) {
                    sim_log_debug(174U, "radio_send", "The MQTT broker tries to forward the publish request to node %hhu at time %s \n", l + 2, sim_time_string());
                    sim_log_debug(175U, "radio_pack", ">>>Pack \n \t Payload length %hhu \n", mqttC$Packet$payloadLength(&mqttC$packet[sim_node()]));
                    sim_log_debug_clear(176U, "radio_pack", "\t Source: %hhu \n", mqttC$AMPacket$source(&mqttC$packet[sim_node()]));
                    sim_log_debug_clear(177U, "radio_pack", "\t Destination: %hhu \n", mqttC$AMPacket$destination(&mqttC$packet[sim_node()]));
                    sim_log_debug_clear(178U, "radio_pack", "\t AM Type: %hhu \n", mqttC$AMPacket$type(&mqttC$packet[sim_node()]));
                    sim_log_debug_clear(179U, "radio_pack", "\t\t Message type: %hhu \n", __nesc_ntoh_uint8(mess->type.nxdata));
                    sim_log_debug_clear(180U, "radio_pack", "\t\t Topic: %hhu \n", __nesc_ntoh_uint8(mess->topic.nxdata));
                    sim_log_debug_clear(181U, "radio_pack", "\t\t QOS: %hhu \n", __nesc_ntoh_uint8(mess->qos.nxdata));
                    sim_log_debug_clear(182U, "radio_pack", "\t\t Value: %hhu \n", __nesc_ntoh_uint16(mess->value.nxdata));
                    sim_log_debug_clear(183U, "radio_pack", "\t\t Initial source: %hhu \n", __nesc_ntoh_uint8(mess->source.nxdata));
                  }
              }
            }
        }
      if (found == 0 && l == 6 - 1 && mqttC$forwardRetrans[sim_node()] == 0) {
          mqttC$forwarding[sim_node()] = 0;
          sim_log_debug_clear(184U, "radio_pack", "\t\t forwarding: %hhu \n", mqttC$forwarding[sim_node()]);
        }
      if (mqttC$forwardRetrans[sim_node()] == 1 && l == 6 - 1) {
          mqttC$forwardRetrans[sim_node()] = 0;
          mqttC$index[sim_node()] = 0;
          mqttC$sendForward$postTask();
        }
    }
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  mqttC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb7466258, message_t * msg, error_t error){
#line 100
  switch (arg_0xb7466258) {
#line 100
    case 0U:
#line 100
      /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb7466258, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb781f650){
#line 75
  switch (arg_0xb781f650) {
#line 75
...
#line 75
      break;
#line 75
    case mqttC$initialize:
#line 75
      mqttC$initialize$runTask();
#line 75
      break;
#line 75
    case mqttC$sendConnect:
#line 75
      mqttC$sendConnect$runTask();
#line 75
      break;
#line 75
    case mqttC$sendSubscribe:
#line 75
      mqttC$sendSubscribe$runTask();
#line 75
      break;
#line 75
    case mqttC$sendPublish:
#line 75
      mqttC$sendPublish$runTask();
#line 75
      break;
#line 75
    case mqttC$sendForward:
#line 75
      mqttC$sendForward$runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb781f650);
#line 75
      break;
#line 75
    }
...
#line 53
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t mqttC$sendConnect$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(mqttC$sendConnect);
#line 67
...
#line 204
{
  mqttC$sendConnect$postTask();
}

# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t mqttC$sendSubscribe$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(mqttC$sendSubscribe);
#line 67
...
#line 210
{
  mqttC$sendSubscribe$postTask();
}

# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t mqttC$sendPublish$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(mqttC$sendPublish);
#line 67
...
#line 216
{
  if (mqttC$retransmission[sim_node()] == 0) {
      mqttC$sendPublish$postTask();
    }
}
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 415
{
  my_msg_publish_t *mess = (my_msg_publish_t *)mqttC$Packet$getPayload(&mqttC$packet[sim_node()], sizeof(my_msg_publish_t ));

#line 417
  if (mqttC$retransmission[sim_node()] == 1) {
      __nesc_hton_uint16(mess->value.nxdata, mqttC$valueRetrans[sim_node()]);
    }
  else 
#line 419
    {
      __nesc_hton_uint16(mess->value.nxdata, data);
      mqttC$valueRetrans[sim_node()] = data;
    }
  __nesc_hton_uint8(mess->type.nxdata, 3);
  __nesc_hton_uint8(mess->msgId.nxdata, mqttC$messageID[sim_node()]);
  if (TOS_NODE_ID == 2 || TOS_NODE_ID == 3) {
      __nesc_hton_uint8(mess->topic.nxdata, 1);
    }
  else 
#line 427
    {
      if (TOS_NODE_ID == 4 || TOS_NODE_ID == 5) {
          __nesc_hton_uint8(mess->topic.nxdata, 2);
        }
    }

  if (TOS_NODE_ID < 4) {
      __nesc_hton_uint8(mess->qos.nxdata, 1);
    }
  else 
#line 435
    {
      __nesc_hton_uint8(mess->qos.nxdata, 0);
    }

  sim_log_debug(247U, "radio_send", "Try to send a publish request to node 1 (MQTT Broker) at time %s \n", sim_time_string());

  if (__nesc_ntoh_uint8(mess->qos.nxdata) == 1) {
      mqttC$PacketAcknowledgements$requestAck(&mqttC$packet[sim_node()]);
    }
  else 
#line 443
  ...
  if (mqttC$AMSend$send(1, &mqttC$packet[sim_node()], sizeof(my_msg_publish_t )) == SUCCESS) {
      sim_log_debug(248U, "radio_send", "Packet passed to lower layer successfully!\n");
      sim_log_debug(249U, "radio_pack", ">>>Pack\n \t Payload length %hhu \n", mqttC$Packet$payloadLength(&mqttC$packet[sim_node()]));
      sim_log_debug_clear(250U, "radio_pack", "\t Source: %hhu \n ", mqttC$AMPacket$source(&mqttC$packet[sim_node()]));

      sim_log_debug_clear(251U, "radio_pack", "\t Destination: %hhu \n ", mqttC$AMPacket$destination(&mqttC$packet[sim_node()]));
      sim_log_debug_clear(252U, "radio_pack", "\t AM Type: %hhu \n ", mqttC$AMPacket$type(&mqttC$packet[sim_node()]));
      sim_log_debug_clear(253U, "radio_pack", "\t\t Message type: %hhu \n", __nesc_ntoh_uint8(mess->type.nxdata));
      sim_log_debug_clear(254U, "radio_pack", "\t\t Topic: %hhu \n", __nesc_ntoh_uint8(mess->topic.nxdata));
      sim_log_debug_clear(255U, "radio_pack", "\t\t QOS: %hhu \n", __nesc_ntoh_uint8(mess->qos.nxdata));
      sim_log_debug_clear(256U, "radio_pack", "\t\t Value: %hhu \n", __nesc_ntoh_uint16(mess->value.nxdata));
      sim_log_debug_clear(257U, "radio_pack", "\t\t Message ID: %hhu \n", __nesc_ntoh_uint8(mess->msgId.nxdata));
    }
}

# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static void /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val){
#line 63
  mqttC$Read$readDone(result, val);
#line 63
}
#line 63
# 24 "FakeSensorP.nc"
...
#line 24
{
  /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, 10 * /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16());
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb72e83a8){
#line 83
  switch (arg_0xb72e83a8) {
#line 83
    case 0U:
#line 83
      mqttC$Timer0$fired();
...
#line 83
    case 5U:
#line 83
      /*mqttAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb72e83a8);
#line 83
      break;
#line 83
    }
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb7466c40, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb7466c40, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static bool mqttC$PacketAcknowledgements$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
#line 85
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void mqttC$Timer1$startOneShot(uint32_t dt){
#line 73
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void mqttC$Timer2$startPeriodic(uint32_t dt){
#line 64
...
inline static void mqttC$Timer3$startOneShot(uint32_t dt){
#line 73
...
#line 577
{
  sim_log_debug(289U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(288U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(285U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(286U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(278U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(268U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 225
  sim_log_debug(275U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(280U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 62
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void mqttC$Timer0$startOneShot(uint32_t dt){
#line 73
...
#line 194
{
  sim_log_debug(185U, "boot", "Application booted.\n");
  mqttC$SplitControl$start();
  if (TOS_NODE_ID > 1) {
      mqttC$Timer0$startOneShot(1000);
    }
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
static uint8_t mqttC$Packet$payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 285
  ...
  sim_log_debug(277U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(283U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
# 134 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
static error_t TossimPacketModelC$PacketAcknowledgements$noAck(message_t *ack)
#line 134
{
...
#line 55
{
  /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*mqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
...
#line 260
  if (&mqttC$packet[sim_node()] == buf && err == SUCCESS) {
      sim_log_debug(189U, "radio_send", "Packet sent...");
      if (__nesc_ntoh_uint8(mess->type.nxdata) == 1) {
          if (mqttC$PacketAcknowledgements$wasAcked(buf)) {
              sim_log_debug_clear(190U, "radio_ack", "and CONNACK received");
              sim_log_debug_clear(191U, "radio_send", " at time %s \n", sim_time_string());
              mqttC$Timer1$startOneShot(1000);
            }
          else 
#line 267
            {
              sim_log_debug_clear(192U, "radio_ack", "but CONNACK was not received");
              sim_log_debug_clear(193U, "radio_send", " at time %s \n", sim_time_string());
              mqttC$Timer0$startOneShot(1000);
            }
        }
      if (__nesc_ntoh_uint8(mess->type.nxdata) == 2) {
          if (mqttC$PacketAcknowledgements$wasAcked(buf)) {
              sim_log_debug_clear(194U, "radio_ack", "and SUBACK received");
              sim_log_debug_clear(195U, "radio_send", " at time %s \n", sim_time_string());
              mqttC$Timer2$startPeriodic(20000);
            }
          else 
#line 278
            {
              sim_log_debug_clear(196U, "radio_ack", "but SUBACK was not received");
              sim_log_debug_clear(197U, "radio_send", " at time %s \n", sim_time_string());
              mqttC$Timer1$startOneShot(1000);
            }
        }
      if (__nesc_ntoh_uint8(mess->type.nxdata) == 3) {
          my_msg_publish_t *messPublish = (my_msg_publish_t *)mqttC$Packet$getPayload(&mqttC$packet[sim_node()], sizeof(my_msg_publish_t ));

#line 286
          if (__nesc_ntoh_uint8(messPublish->qos.nxdata) == 1) {
              if (mqttC$PacketAcknowledgements$wasAcked(buf)) {
                  sim_log_debug_clear(198U, "radio_ack", "and PUBACK received");
                  sim_log_debug_clear(199U, "radio_send", " at time %s \n", sim_time_string());
                  mqttC$messageID[sim_node()]++;
                  mqttC$retransmission[sim_node()] = 0;
                }
              else 
#line 292
                {
                  sim_log_debug_clear(200U, "radio_ack", "but PUBACK was not received");
                  sim_log_debug_clear(201U, "radio_send", " at time %s \n", sim_time_string());
                  mqttC$retransmission[sim_node()] = 1;
                  mqttC$Timer3$startOneShot(10);
                }
            }
          else 
#line 298
            {
              mqttC$messageID[sim_node()]++;
              sim_log_debug_clear(202U, "radio_ack", "The QoS was low so no acknowledgment required for this publication\n");
            }
        }
      if (__nesc_ntoh_uint8(mess->type.nxdata) == 4) {
          if (nodesToForward[mqttC$index[sim_node()]] == 1) {
              if (mqttC$PacketAcknowledgements$wasAcked(buf)) {
                  nodesToForward[mqttC$index[sim_node()]] = -1;
                  mqttC$index[sim_node()]++;
                  sim_log_debug_clear(203U, "radio_ack", "and FORWACK received");
                  sim_log_debug_clear(204U, "radio_send", " at time %s \n", sim_time_string());
                }
              else 
#line 310
                {
                  mqttC$forwardRetrans[sim_node()] = 1;
                  mqttC$index[sim_node()]++;
                  sim_log_debug_clear(205U, "radio_ack", "but FORWACK was not received");
                  sim_log_debug_clear(206U, "radio_send", " at time %s \n", sim_time_string());
                }
            }
          else 
#line 316
            {
              nodesToForward[mqttC$index[sim_node()]] = -1;
              sim_log_debug_clear(207U, "radio_ack", "and no acknowledgement required \n");
            }
          mqttC$sendForward$postTask();
        }
    }
...
#line 101
      sim_log_debug(263U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(264U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(265U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(266U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(284U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(287U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(276U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module mqttC */
  if (!strcmp(varname, "mqttC$nbNodesConnected"))
  {
    *addr = (uintptr_t)&mqttC$nbNodesConnected[__nesc_mote];
    *size = sizeof(mqttC$nbNodesConnected[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "mqttC$messageID"))
  {
    *addr = (uintptr_t)&mqttC$messageID[__nesc_mote];
    *size = sizeof(mqttC$messageID[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "mqttC$retransmission"))
  {
    *addr = (uintptr_t)&mqttC$retransmission[__nesc_mote];
    *size = sizeof(mqttC$retransmission[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "mqttC$valueRetrans"))
  {
    *addr = (uintptr_t)&mqttC$valueRetrans[__nesc_mote];
    *size = sizeof(mqttC$valueRetrans[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "mqttC$valueToForward"))
  {
    *addr = (uintptr_t)&mqttC$valueToForward[__nesc_mote];
    *size = sizeof(mqttC$valueToForward[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "mqttC$topicToForward"))
  {
    *addr = (uintptr_t)&mqttC$topicToForward[__nesc_mote];
    *size = sizeof(mqttC$topicToForward[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "mqttC$sourceToForward"))
  {
    *addr = (uintptr_t)&mqttC$sourceToForward[__nesc_mote];
    *size = sizeof(mqttC$sourceToForward[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "mqttC$index"))
  {
    *addr = (uintptr_t)&mqttC$index[__nesc_mote];
    *size = sizeof(mqttC$index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "mqttC$forwardRetrans"))
  {
    *addr = (uintptr_t)&mqttC$forwardRetrans[__nesc_mote];
    *size = sizeof(mqttC$forwardRetrans[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "mqttC$forwarding"))
  {
    *addr = (uintptr_t)&mqttC$forwarding[__nesc_mote];
    *size = sizeof(mqttC$forwarding[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "mqttC$packet"))
  {
    *addr = (uintptr_t)&mqttC$packet[__nesc_mote];
    *size = sizeof(mqttC$packet[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module mqttC */
  mqttC$nbNodesConnected[__nesc_mote] = 0;
  mqttC$messageID[__nesc_mote] = 1;
  mqttC$retransmission[__nesc_mote] = 0;
  mqttC$valueRetrans[__nesc_mote] = -1;
  mqttC$valueToForward[__nesc_mote] = -1;
  mqttC$topicToForward[__nesc_mote] = -1;
  mqttC$sourceToForward[__nesc_mote] = -1;
  mqttC$index[__nesc_mote] = 0;
  mqttC$forwardRetrans[__nesc_mote] = 0;
  mqttC$forwarding[__nesc_mote] = 0;
  memset((void *)&mqttC$packet[__nesc_mote], 0, sizeof mqttC$packet[__nesc_mote]);
