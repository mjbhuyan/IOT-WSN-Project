...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b4f458, const void *arg_0xb7b4f5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
# 74 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/tos.h"
...
# 98 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/tos.h"
...
unsigned int (*hashfunction)(void *arg_0xb79aa840), 
int (*key_eq_fn)(void *arg_0xb79aac88, void *arg_0xb79aae00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78799b8, int arg_0xb7879b10);
static inline double RandomUniform(void );
...
# 63 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim_serial_packet.h"
...
# 50 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim_serial_packet.c"
...
# 48 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim_serial_forwarder.h"
...
# 50 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
am_id_t arg_0xb7496178, 
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 110
static void SerialActiveMessageC$AMSend$default$sendDone(
# 50 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
am_id_t arg_0xb7496178, 
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
message_t * msg, 
...
# 51 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
am_id_t arg_0xb7496b38, 
# 71 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
message_t * msg, 
void * payload, 
...
# 16 "TestSerialC.nc"
message_t TestSerialC$packet[1000];

bool TestSerialC$locked[1000];
uint16_t TestSerialC$counter[1000];
...
# 63 "/opt/tinyos-main-2.1.2/tos/lib/tossim/CpmModelC.nc"
...
# 74 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
enum SerialActiveMessageC$__nesc_unnamed4333 {
#line 74
...
enum SerialActiveMessageC$__nesc_unnamed4334 {
#line 75
...
#line 119
enum SerialActiveMessageC$__nesc_unnamed4335 {
#line 119
...
#line 252
static inline message_t *SerialActiveMessageC$Receive$default$receive(am_id_t id, message_t *msg, void *payload, uint8_t len);
...
static inline void SerialActiveMessageC$AMSend$default$sendDone(uint8_t id, message_t *msg, error_t err);
#line 272
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb75b05b8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb75b05b8, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb75b2e70, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb75b2e70, msg, payload, len);
#line 78
...
# 52 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim_serial_packet.c"
inline static serial_header_t *getSerialHeader(message_t *msg)
#line 52
{
...
# 252 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
static inline message_t *SerialActiveMessageC$Receive$default$receive(am_id_t id, message_t *msg, void *payload, uint8_t len)
#line 252
{
  return msg;
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * SerialActiveMessageC$Receive$receive(am_id_t arg_0xb7496b38, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = SerialActiveMessageC$Receive$default$receive(arg_0xb7496b38, msg, payload, len);
#line 78
...
#line 78
# 70 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
static inline serial_header_t *SerialActiveMessageC$getHeader(message_t *amsg)
#line 70
{
...
# 316 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
static inline void TossimPacketModelC$Control$default$startDone(error_t err)
#line 316
{
  return;
...
# 220 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$AMSend$default$sendDone(uint8_t id, message_t *msg, error_t err)
#line 220
{
  return;
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb75b24b0, message_t * msg, error_t error){
#line 110
    TossimActiveMessageC$AMSend$default$sendDone(arg_0xb75b24b0, msg, error);
#line 110
}
#line 110
...
#line 51
{
  sim_log_debug(48U, "init", "Node started!\n");
  if (err == SUCCESS) {
...
#line 138
# 75 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
static inline void SerialActiveMessageC$stopDone$runTask(void )
#line 75
{
#line 75
...
#line 45
{
  if (&TestSerialC$packet[sim_node()] == bufPtr) {
      TestSerialC$locked[sim_node()] = FALSE;
    }
}

# 260 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
static inline void SerialActiveMessageC$AMSend$default$sendDone(uint8_t id, message_t *msg, error_t err)
#line 260
{
  return;
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void SerialActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7496178, message_t * msg, error_t error){
#line 110
  switch (arg_0xb7496178) {
#line 110
...
#line 110
    default:
#line 110
      SerialActiveMessageC$AMSend$default$sendDone(arg_0xb7496178, msg, error);
#line 110
      break;
#line 110
    }
...
#line 110
# 115 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
static inline void SerialActiveMessageC$Model$sendDone(message_t *msg, error_t result)
#line 115
{
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7b87b28){
#line 75
  switch (arg_0xb7b87b28) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7b87b28);
#line 75
      break;
#line 75
    }
...
#line 67
# 124 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
static inline error_t SerialActiveMessageC$Model$default$send(int node, message_t *msg, uint8_t len)
#line 124
{
  ...
  sim_log_debug(162U, "Serial", "Sending serial message (%p) of type %hhu and length %hhu @ %s.\n", msg, SerialActiveMessageC$AMPacket$type(msg), len, sim_time_string());
...
#line 57
# 87 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
static inline error_t SerialActiveMessageC$AMSend$send(am_id_t id, am_addr_t addr, 
message_t *amsg, 
uint8_t len)
#line 89
...
#line 80
  __nesc_result = SerialActiveMessageC$AMSend$send(AM_TEST_SERIAL_MSG, addr, msg, len);
#line 80
...
#line 80
# 106 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
...
#line 106
  __nesc_result = SerialActiveMessageC$Packet$maxPayloadLength();
#line 106
...
#line 25
{
  TestSerialC$counter[sim_node()]++;
  if (TestSerialC$locked[sim_node()]) {
      return;
    }
  else {
      test_serial_msg_t *rcm = (test_serial_msg_t *)TestSerialC$Packet$getPayload(&TestSerialC$packet[sim_node()], sizeof(test_serial_msg_t ));
...
#line 33
      ...
      __nesc_hton_uint16(rcm->sample_value.nxdata, TestSerialC$counter[sim_node()]);
      if (TestSerialC$AMSend$send(AM_BROADCAST_ADDR, &TestSerialC$packet[sim_node()], sizeof(test_serial_msg_t )) == SUCCESS) {
          TestSerialC$locked[sim_node()] = TRUE;
          sim_log_debug(47U, "init", "Packet sent...\n");
        }
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb730bc70){
#line 83
  switch (arg_0xb730bc70) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb730bc70);
#line 83
      break;
#line 83
    }
...
#line 57
  {
    sim_log_debug(49U, "Init", "LEDS: initialized.\n");
...
#line 67
# 77 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
static inline error_t SerialActiveMessageC$SplitControl$start(void )
#line 77
{
...
# 56 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim_serial_packet.c"
  void sim_serial_packet_set_destination(sim_serial_packet_t *msg, uint16_t dest)
#line 56
{
...
# 293 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
  void serial_active_message_deliver(int node, message_t *msg, sim_time_t t)
#line 293
{
...
# 108 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim_serial_packet.c"
  uint8_t sim_serial_packet_max_length(sim_serial_packet_t *msg)
#line 108
{
  return 28;
...
{
  /* Module TestSerialC */
  if (!strcmp(varname, "TestSerialC$packet"))
  {
    *addr = (uintptr_t)&TestSerialC$packet[__nesc_mote];
    *size = sizeof(TestSerialC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TestSerialC$locked"))
  {
    *addr = (uintptr_t)&TestSerialC$locked[__nesc_mote];
    *size = sizeof(TestSerialC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TestSerialC$counter"))
  {
    *addr = (uintptr_t)&TestSerialC$counter[__nesc_mote];
    *size = sizeof(TestSerialC$counter[__nesc_mote]);
    return 0;
  }
...
{
  /* Module TestSerialC */
  memset((void *)&TestSerialC$packet[__nesc_mote], 0, sizeof TestSerialC$packet[__nesc_mote]);
  TestSerialC$locked[__nesc_mote] = FALSE;
  TestSerialC$counter[__nesc_mote] = 0;
